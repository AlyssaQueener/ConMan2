...
similarity = 1 - cosine(complete_embedding_rotated, complete_embedding_scaled)
similarity_1 = 1 - cosine(complete_embedding_rotated, complete_embedding_translated)
similarity_2 = 1 - cosine(complete_embedding_translated, complete_embedding_scaled)
#print(f"Similarity between rotated and translated: {similarity}")

print("Similarity Rotated - Scaled")
print(similarity)

print("Similarity Rotated - Translated")
print(similarity_1)

print("Similarity Scaled - Translated")
print(similarity_2)