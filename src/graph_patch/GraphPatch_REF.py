...
class GraphPatch:
    ...
    def apply_patch(self, timestamp_init: str, timestamp_updt:str):
        ...
        print(self.unique_paths_to_node_mapping)
                ...
                if gluing_relation["direction"] == "pushout_to_context":
                    ...
                    for pushout_contestant in pushout_contestants:
                        ...
                        if (
                            ...
                            and pushout_contestant not in self.gluing_nodes
                        ):
                            self.gluing_nodes.append(pushout_contestant)
        ...
        for gluing_node in self.gluing_nodes:
