...
models = [
    {
        "path_init": "src/08_testgml/test-for-cross-scale/test1.ifc",
        "timestamp_init": "move-c-gml",
        "path_updt": "src/08_testgml/test-for-cross-scale/test-column-move1.ifc",
        "timestamp_updt": "v2-move-c",
        "graph_type": "move-c-gml"
    },
    {
        "path_init": "src/08_testgml/test-for-cross-scale/test-column-move1.ifc",
        "timestamp_init": "delete-c-gml",
        "path_updt": "src/08_testgml/test-for-cross-scale/test1-delete-column.ifc",
        "timestamp_updt": "v2-delete-c",
        "graph_type": "delete-c-gml"
    }
]
